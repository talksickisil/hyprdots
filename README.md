...
> This is a fork with updates made to add a few additional applications and update settings to my preference. Such as: US format date and time. I've also updated configs of waybar, swaylock-effects, kitty, and fastfetch. This is just a fork I made to make deployment easier on myself. 
...
```shell
pacman -Sy git
git clone --depth 1 https://github.com/talksickisil/hyprdots ~/HyDE
cd ~/HyDE/Scripts
./install.sh
```
